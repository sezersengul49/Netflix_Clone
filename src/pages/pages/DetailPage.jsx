       ...
       : (
        <div>
          <div className="relative h-[25vh]">
            <img className="object-cover h-full w-full" src= {baseImgUrl + movie.backdrop_path} />
          ...
          <div className="my-10 grid grid-cols-1 md:grid-cols-2">
            <div>
             ...
             <DetailDisplay title= {'Yapımcı Şirketler'}  data= {movie.
            production_companies} />
             ...
             <div>
              <p>{movie.overview}</p>
              <p><span>Bütçe: </span>
              <span className="text-green-500 ms-2"> ${millify(movie.budget)}</span></p>
